...
def Colorize(FILE):
	...
	subprocess.call("convert " + str(FILE) + " colortables/" + str(wlen) + "_color_table.png -clut " + convert_out, shell = True)
...
def Annotate(FILE):
	...
	draw.text((102, 3705), "Temperature: ", font = header_font, fill = (b, g, r, a))
	draw.text((102, 3785), temperature_text, font = body_font, fill = (b, g, r, a))
	draw.text((3500, 3705), "Observation Time:", font = header_font, fill = (b, g, r, a))
	draw.text((3500, 3785), str(date), font = body_font, fill = (b, g, r, a))
	draw.text((3500, 3855), str(time), font = body_font, fill = (b, g, r, a))
