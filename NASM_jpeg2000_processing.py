...
def Colorize(FILE):
	...
	subprocess.call('ffmpeg -i ' + str(FILE) + ' -vf "scale=(iw*sar)*min(4096/(iw*sar)\,3456/ih):ih*min(4096/(iw*sar)\,3456/ih), pad=4096:3456:(4096-iw*min(4096/iw\,3456/ih))/2:(3456-ih*min(3456/iw\,3456/ih))/2:black,\ format=rgb24"  -y ' + str(FILE), shell = True)
